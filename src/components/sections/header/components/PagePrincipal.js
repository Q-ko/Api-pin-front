        ...
        <div className="container d-flex flex-column justify-content-center h-100">
            <div className="row d-flex flex-column align-items-start justify-content-center mb-3">
                <div className="col-12 col-lg-6">
                    <h2 className="text-white h2-title ">AQUI LA PAGINA MAS BUENA DEL MUNDO</h2>
                </div>
            </div>
            <div className="row d-flex flex-column align-items-start justify-content-center my-2">
                <div className="col-12 col-lg-4">
                    <p className=" text-white">texto aleatori para completar la pagina porque no hay lorem</p>
                </div>
            </div>
            <div className="row d-flex flex-column align-items-start justify-content-center mt-3">
